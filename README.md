...
2. Right-click a channel and select **Edit Channel**.
3. Go to **Integrations** > **Webhooks** > **New Webhook**.
4. Click **Copy Webhook URL** and paste it into your GitHub Secrets as `DISCORD_WEBHOOK`.
...
### 👤 Credits
- **Script Logic:** Based on [sjtt2/endfield_auto_sign](https://github.com/sjtt2/endfield_auto_sign)
...
1. 打开 **Discord**，进入你想接收通知的服务器。
2. 右键点击一个频道，选择 **编辑频道 (Edit Channel)**。
3. 前往 **整合 (Integrations)** > **Webhooks** > **新 Webhook (New Webhook)**。
4. 点击 **复制 Webhook URL**，并将其粘贴到 GitHub Secrets 的 `DISCORD_WEBHOOK` 中。
...
### 👤 致谢
- **核心逻辑：** 基于 [sjtt2/endfield_auto_sign](https://github.com/sjtt2/endfield_auto_sign) 的开源方案
